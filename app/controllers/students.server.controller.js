...
exports.saveOAuthUserProfile = function (req, profile, done) {
    ...
    User.findOne({
        ...
        if (err) {
            ...
            if (!user) {
                // Set a possible base student number
                const possibleStudentNumber = profile.studentNumber || ((profile.email) ? profile.email.split('@')[0] : '');

                // Find a unique available student number
                User.findUniqueStudentNumber(possibleStudentNumber, null, (availableStudentNumber) => {
