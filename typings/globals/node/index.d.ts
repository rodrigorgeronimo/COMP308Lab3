...
// Source: https://raw.githubusercontent.com/DefinitelyTyped/DefinitelyTyped/a9a732cb4d68d2fb46313a3ab07114c9bddb03b8/node/node.d.ts
interface Error {
    stack?: string;
}
...
declare module "os" {
    ...
    export function userInfo(options?: { encoding: string }): { studentNumber: string, uid: number, gid: number, shell: any, homedir: string }
